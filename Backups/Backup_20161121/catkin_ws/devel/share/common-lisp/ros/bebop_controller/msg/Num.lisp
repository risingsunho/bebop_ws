...
(cl:in-package bebop_controller-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bebop_controller-msg:<Num> is deprecated: use bebop_controller-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bebop_controller-msg:num-val is deprecated.  Use bebop_controller-msg:num instead.")
  (num m))
