...
typedef enum
{
    ARCOMMANDS_RC_CHANNEL_TYPE_INVALID = 0,    ///< Invalid/Unused channel.
    ARCOMMANDS_RC_CHANNEL_TYPE_ROLL = 1,    ///< Roll axis channel.
    ARCOMMANDS_RC_CHANNEL_TYPE_PITCH = 2,    ///< Pitch axis channel.
    ARCOMMANDS_RC_CHANNEL_TYPE_YAW = 3,    ///< Yaw axis channel.
    ARCOMMANDS_RC_CHANNEL_TYPE_GAZ = 4,    ///< Gaz / Throttle / Altitude axis channel.
    ARCOMMANDS_RC_CHANNEL_TYPE_TAKEOFF_LAND = 5,    ///< Takeoff / Land channel.
    ARCOMMANDS_RC_CHANNEL_TYPE_EMERGENCY = 6,    ///< Emergency channel.
    ARCOMMANDS_RC_CHANNEL_TYPE_RETURN_HOME = 7,    ///< Return Home channel.
    ARCOMMANDS_RC_CHANNEL_TYPE_PILOTING_MODE = 8,    ///< RC Piloting mode.\nAuto mode: used for doing flightplans and for assisted flying\nwith a non-RC controller.\nEasy manual mode: used for assisted flying with a RC controller.\nManual mode: used for non-assisted flying with a RC controller and\nfor directly controlling the servomotors.
    ARCOMMANDS_RC_CHANNEL_TYPE_TAKE_CONTROL = 9,    ///< RC take control.\nWhen take control is activated the RC controller, if\navailable, becomes the main controller.
    ARCOMMANDS_RC_CHANNEL_TYPE_MAX
} eARCOMMANDS_RC_CHANNEL_TYPE;

#define ARCOMMANDS_FLAG_RC_CHANNEL_TYPE_INVALID (1 << ARCOMMANDS_RC_CHANNEL_TYPE_INVALID)    ///< Invalid/Unused channel.
#define ARCOMMANDS_FLAG_RC_CHANNEL_TYPE_ROLL (1 << ARCOMMANDS_RC_CHANNEL_TYPE_ROLL)    ///< Roll axis channel.
#define ARCOMMANDS_FLAG_RC_CHANNEL_TYPE_PITCH (1 << ARCOMMANDS_RC_CHANNEL_TYPE_PITCH)    ///< Pitch axis channel.
#define ARCOMMANDS_FLAG_RC_CHANNEL_TYPE_YAW (1 << ARCOMMANDS_RC_CHANNEL_TYPE_YAW)    ///< Yaw axis channel.
#define ARCOMMANDS_FLAG_RC_CHANNEL_TYPE_GAZ (1 << ARCOMMANDS_RC_CHANNEL_TYPE_GAZ)    ///< Gaz / Throttle / Altitude axis channel.
#define ARCOMMANDS_FLAG_RC_CHANNEL_TYPE_TAKEOFF_LAND (1 << ARCOMMANDS_RC_CHANNEL_TYPE_TAKEOFF_LAND)    ///< Takeoff / Land channel.
#define ARCOMMANDS_FLAG_RC_CHANNEL_TYPE_EMERGENCY (1 << ARCOMMANDS_RC_CHANNEL_TYPE_EMERGENCY)    ///< Emergency channel.
#define ARCOMMANDS_FLAG_RC_CHANNEL_TYPE_RETURN_HOME (1 << ARCOMMANDS_RC_CHANNEL_TYPE_RETURN_HOME)    ///< Return Home channel.
#define ARCOMMANDS_FLAG_RC_CHANNEL_TYPE_PILOTING_MODE (1 << ARCOMMANDS_RC_CHANNEL_TYPE_PILOTING_MODE)    ///< RC Piloting mode.\nAuto mode: used for doing flightplans and for assisted flying\nwith a non-RC controller.\nEasy manual mode: used for assisted flying with a RC controller.\nManual mode: used for non-assisted flying with a RC controller and\nfor directly controlling the servomotors.
#define ARCOMMANDS_FLAG_RC_CHANNEL_TYPE_TAKE_CONTROL (1 << ARCOMMANDS_RC_CHANNEL_TYPE_TAKE_CONTROL)    ///< RC take control.\nWhen take control is activated the RC controller, if\navailable, becomes the main controller.
...
typedef enum
{
    ...
    ARCOMMANDS_UNKNOWN_FEATURE_1_TYPE_LOOK_AT = 1,    ///< LookAt unknown feature_1 type
    ARCOMMANDS_UNKNOWN_FEATURE_1_TYPE_GEOGRAPHIC = 2,    ///< Follow the target keeping the same vector
    ARCOMMANDS_UNKNOWN_FEATURE_1_TYPE_RELATIVE = 3,    ///< Follow the target keeping the same orientation to its direction
...
typedef enum
{
    ...
    ARCOMMANDS_UNKNOWN_FEATURE_1_ANIM_TYPE_SPIRAL = 1,    ///< Current unknown feature_1 animation is spiral
    ARCOMMANDS_UNKNOWN_FEATURE_1_ANIM_TYPE_SWING = 2,    ///< Current unknown feature_1 animation is swing
    ARCOMMANDS_UNKNOWN_FEATURE_1_ANIM_TYPE_BOOMERANG = 3,    ///< Current unknown feature_1 animation is boomerang
    ARCOMMANDS_UNKNOWN_FEATURE_1_ANIM_TYPE_CANDLE = 4,    ///< Current unknown feature_1 animation is candle
    ARCOMMANDS_UNKNOWN_FEATURE_1_ANIM_TYPE_DOLLY_SLIDE = 5,    ///< Current unknown feature_1 animation is dolly slide
...
typedef enum
{
    ...
    ARCOMMANDS_UNKNOWN_FEATURE_1_TYPES_AVAILABLE_LOOK_AT = 1,    ///< LookAt available, no other types
    ARCOMMANDS_UNKNOWN_FEATURE_1_TYPES_AVAILABLE_LOOK_AND_FOLLOW = 2,    ///< LookAt, Geographic and Relative unknown feature_1 are available
