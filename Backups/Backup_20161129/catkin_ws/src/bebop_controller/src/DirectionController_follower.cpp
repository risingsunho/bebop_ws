...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub = nh_.subscribe("/bebop1/odom", 1, velCallback);
    ros::Subscriber sub_direction = nh_.subscribe("/dirvector1", 1, velCallbackDirection);
    pub_setpoint=nh_.advertise<std_msgs::Float64>("/error1", 1);
