...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_B4H.pack(_x.mass_storage_id, _x.nbPhotos, _x.nbVideos, _x.nbPuds, _x.nbCrashLogs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.mass_storage_id, _x.nbPhotos, _x.nbVideos, _x.nbPuds, _x.nbCrashLogs,) = _struct_B4H.unpack(str[start:end])
      return self
